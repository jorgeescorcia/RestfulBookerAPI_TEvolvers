...
@Slf4j
public class GetConsultaReserva implements Interaction {
    ...
    public GetConsultaReserva(String baseUrl, String request, String typeContent) {
    ...
    public static GetConsultaReserva params(String baseUrl, String request, String typeContent){
        return Tasks.instrumented(GetConsultaReserva.class, baseUrl, request, typeContent);
    }
}
