...
@Slf4j
public class PostCrearReserva implements Interaction {
    ...
    public PostCrearReserva(String baseUrl, String bodyRequest, String requestUri, String typeContent) {
    ...
    public static PostCrearReserva params(String baseUrl, String bodyRequest, String requestUri, String typeContent) {
        return Tasks.instrumented(PostCrearReserva.class, baseUrl, bodyRequest, requestUri, typeContent);
    }
}
